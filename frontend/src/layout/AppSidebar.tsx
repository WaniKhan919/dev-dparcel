...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      { name: "Roles",  path: "/basic-tables" },
      { name: "Permissions", path: "/basic-tables" },
    ],
  },
  {
    icon: <LockIcon />,
        ...
        <li key={nav.name}>
          {nav.subItems ? (
            ...
            nav.path && (
              <Link
                to={nav.path}
                className={`menu-item group ${isActive(nav.path) ? "bg-[linear-gradient(90deg,rgba(255,255,255,0.15),rgba(255,255,255,0.05))] text-white" : "text-white hover:bg-[linear-gradient(90deg,rgba(255,255,255,0.15),rgba(255,255,255,0.05))]"
                  }`}
              >
                <span
